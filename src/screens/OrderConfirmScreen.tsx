...
import { DELETE_ORDER } from "../Tools/Mutation";
  ...
  return (
    <ScrollView>
       <View style={styles.container}>
        ...
        <View style={{flexDirection: "row",  justifyContent:"flex-end", margin: 10, paddingRight: 20,}} >
          <Text style={{borderTopColor: "black", borderTopWidth: 2, paddingTop: 5, fontSize: 25 }}>Total : {totalPrice} €</Text></View>
        </View>
        
        <View>
          <TouchableOpacity
            onPress={() =>
              navigation.navigate("Payment", { screen: "PaymentScreen" })
            }
            >
            <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 10 }}>
